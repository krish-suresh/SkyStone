...
public class Camera implements Subsystem {
    ...
    public Mat getSkyStone(Bitmap bm) {
        ...
        double leftYellowArea = VisionUtils.hsvToTotalAreaInMask(hsvLeft, new Scalar(15, 100, 100), new Scalar(40, 255, 255), "leftY");
        double middleYellowArea = VisionUtils.hsvToTotalAreaInMask(hsvMiddle, new Scalar(15, 100, 100), new Scalar(40, 255, 255), "middleY");
